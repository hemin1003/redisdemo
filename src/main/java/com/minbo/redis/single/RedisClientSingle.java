...
public class RedisClientSingle {
	...
	private static RedisServiceSingleImpl redisService = new RedisServiceSingleImpl();
	...
	public String set(String key, String value) {
		...
		JedisPool pool = redisService.getJedisPool();
		...
		try {
			...
			redisService.returnResource(jedis, flag);
		}
		return result;
	}
